...
router.get('/get-grades' , authenticate, authorize(['admin', 'super', 'parent', 'teacher']) , gradeController.getAllGrades);

// GET /grade by id
router.get('/get-grade/:id' , authenticate, authorize(['admin', 'super', 'parent', 'teacher']) , gradeController.getGradeById);
